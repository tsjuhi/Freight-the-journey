                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled g-2 my-6">
                        <li class="mb-2 d-flex align-items-center"><i
                                class="ti ti-circle-filled ti-10px text-secondary me-2"></i><span>10 Users</span></li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="ti ti-circle-filled ti-10px text-secondary me-2"></i><span>Up to 10 GB storage</span>
                        </li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="ti ti-circle-filled ti-10px text-secondary me-2"></i><span>Basic Support</span></li>
                    </ul>
        ...
        <div class="col-xl-8 col-lg-7 order-0 order-md-1">
            ...
            <div class="card mb-6">
                ...
                <div class="card-header">
                    ...
                    <span class="card-subtitle fw-medium">Change to notification settings, the user will get the
                        update</span>
                </div>
