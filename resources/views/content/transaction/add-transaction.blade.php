...
@section('title', ' Add Transation - Transaction')
        ...
        <div class="col-xl mb-6">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('app-transaction') }}" class="btn btn-primary">
...
<script type="module">
    document.getElementById('add-document').addEventListener('click', function() {
        var tableBody = document.querySelector('#member-document tbody');
        ...
        <td>
            <input type="file" class="form-control" id="document_file" name="document_file" 
                   accept=".png,.jpg,.jpeg,.pdf,.xls,.doc,.docx" required>
        </td>
        <td>
    ...
    // Delegate remove button click event to the table body
    document.querySelector('#member-document tbody').addEventListener('click', function(event) {
