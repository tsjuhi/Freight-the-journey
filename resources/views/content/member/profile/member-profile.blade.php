        ...
        <div class="col-md-12">
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('company-profile') }}"><i
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled my-3 py-1">
                        <li class="d-flex align-items-center mb-4">
                            <i class="ti ti-user ti-lg" aria-hidden="true"></i>
                            <strong class="mx-2">Full Name:</strong>
                            <span>John Doe</span>
                        </li>
                        <li class="d-flex align-items-center mb-4">
                            <i class="ti ti-mail ti-lg" aria-hidden="true"></i>
                            <strong class="mx-2">Email:</strong>
                            <span>john@gmail.com</span>
                        </li>
                        <li class="d-flex align-items-center mb-4">
                            <i class="ti ti-key ti-lg" aria-hidden="true"></i>
                            <strong class="mx-2">Password:</strong>
                            <span>123456789</span>
                        </li>
                        <li class="d-flex align-items-center mb-2">
                            <i class="ti ti-briefcase ti-lg" aria-hidden="true"></i>
                            <strong class="mx-2">Job Title:</strong>
                            <span>Not Provided</span>
                        </li>
                        <li class="d-flex align-items-center mb-4">
                            <i class="ti ti-check ti-lg" aria-hidden="true"></i>
                            <strong class="mx-2">Status:</strong>
                            <span>Active</span>
                        </li>
                    </ul>
