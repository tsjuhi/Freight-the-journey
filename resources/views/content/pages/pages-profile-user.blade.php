...
@section('content')
                            ...
                            <div class="user-profile-info">
                                ...
                                <ul
                                    ...
                                    <li class="list-inline-item d-flex gap-2 align-items-center">
                                        <i class='ti ti-user'></i><span class="fw-medium">Admin</span>
                                    </li>
                                    {{-- <li class="list-inline-item d-flex gap-2 align-items-center">
    ...
    <div class="row">
            ...
            <div class="card mb-6">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled my-3 py-1">
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-user ti-lg"></i>
                            <strong class="mx-2">Full Name:</strong> <span>John Doe</span>
                        </li>
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-check ti-lg"></i>
                            <strong class="mx-2">Status:</strong> <span>Active</span>
                        </li>
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-crown ti-lg"></i>
                            <strong class="mx-2">Role:</strong> <span>Admin</span>
                        </li>
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-flag ti-lg"></i>
                            <strong class="mx-2">Country:</strong> <span>USA</span>
                        </li>
                        <li class="d-flex align-items-center mb-2"><i class="ti ti-language ti-lg"></i>
                            <strong class="mx-2">Languages:</strong> <span>English</span>
                        </li>
                    </ul>
        ...
        <div class="col-md-6">
            <!-- About User -->
            <div class="card mb-6" style="height:295px">
                <div class="card-body">
                    <small class="card-text text-uppercase text-muted small">Contacts</small>
                    <ul class="list-unstyled my-3 py-1">
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-phone-call ti-lg"></i>
                            <strong class="mx-2">Contact:</strong> <span>(123) 456-7890</span>
                        </li>
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-messages ti-lg"></i>
                            <strong class="mx-2">Skype:</strong> <span>john.doe</span>
                        </li>
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-mail ti-lg"></i>
                            <strong class="mx-2">Email:</strong> <span>john.doe@example.com</span>
                        </li>
        ...
        {{-- <div class="col-md-6">
            ...
            <div class="card card-action mb-6">
                <div class="card-header align-items-center">
                    <h5 class="card-action-title mb-0"><i class='ti ti-chart-bar ti-lg text-body me-4'></i>Activity Timeline
                    </h5>
                </div>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            <ul
                                                ...
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    <img class="rounded-circle"
                                                        src="{{ asset('assets/img/avatars/4.png') }}" alt="Avatar" />
                                                </li>
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-bs-placement="top" title="Julee Rossignol"
                                                    class="avatar pull-up">
                                                    <img class="rounded-circle"
                                                        src="{{ asset('assets/img/avatars/2.png') }}" alt="Avatar" />
                                                </li>
                                                <li class="avatar">
